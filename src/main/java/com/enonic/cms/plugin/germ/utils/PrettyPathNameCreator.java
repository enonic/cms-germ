...
import static com.enonic.cms.plugin.germ.utils.NameGenerator.transcribe;
...
public class PrettyPathNameCreator {
    ...
    public final static String DEFAULT_PATHNAME = "branch";

    private final static Pattern STRIP_BEGINNING_PATTERN = Pattern.compile("^([0-9|\\.|\\-|_]+)(.*)$");
