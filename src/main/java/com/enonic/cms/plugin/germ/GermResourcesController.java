...
@Component
public class GermResourcesController
    extends HttpController
{

    final Logger LOG = LoggerFactory.getLogger( GermResourcesController.class );

    Map<String, String> supportedContentTypes =
        ImmutableMap.of( "css", "text/css", "js", "text/js", "html", "text/html", "png", "image/png" );

    public GermResourcesController()
        throws Exception
    {
